...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th3 02, 2019 lúc 05:45 PM
...
CREATE TABLE `config` (
  ...
  `banner4` text COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'HYUNDAI Á CHÂU', '', 'Hyundai', 'Hyundai', 'logo.png', '', '', '', '37 lê văn lương', 'contact@hyundaiahau.com', '0963.369.169', '0918 01 91 91', '0938 553 228 - 0938 255 229', '0903386990', '<li><a href=\"\">NEW PORTER H150 - 1.5 Tấn</a></li>\r\n                                        <li><a href=\"\">HD270 TRỘN BÊ TÔNG</a></li>\r\n                                        <li><a href=\"\">SOLATI 16 Chỗ</a></li>\r\n                                        <li><a href=\"\">UNIVERSE 45 Chỗ</a></li>\r\n                                        <li><a href=\"\">HD270 TỰ ĐỔ</a></li>\r\n                                        <li><a href=\"\">HD320 - 17 TẤN</a></li>', '<li><a href=\"\">Chọn xe</a></li>\r\n                                        <li><a href=\"\">Đăng ký lái thử</a></li>\r\n                                        <li><a href=\"\">Khuyến mãi</a></li>\r\n                                        <li><a href=\"\">Tư vấn bảo hiểm</a></li>\r\n                                        <li><a href=\"\">Tư vấn mua xe trả góp</a></li>', '<li><a href=\"\">Cứu hộ giao thông</a></li>\r\n                                        <li><a href=\"\">Bảo dưỡng định kỳ</a></li>\r\n                                        <li><a href=\"\">Làm đẹp xe</a></li>\r\n                                        <li><a href=\"\">Dịch vụ đồng sơn</a></li>\r\n                                        <li><a href=\"\">Phụ tùng & phụ kiện chính hãng</a></li>', '', '[\"{\\\"image\\\":\\\"background11.jpg\\\"}\",\"{\\\"image\\\":\\\"background111.jpg\\\"}\",\"{\\\"image\\\":\\\"background112.jpg\\\"}\"]', 'avits-smart-readingbrphat-trien-ngon-ngu-tieng-viet-4-10-tuoi', 'avits-mathbrtu-duy-toan-my-ixl-4-14-tuoi', 'avits-mathbrtoan', 'khuyenmai.jpg', 'dangkylaithu.jpg', 'dichvu.jpg', 'logo.png', 'chonxe.jpg');
...
(1, 1, 'vn', 'HYUNDAI Á CHÂU', '', 'Hyundai', 'Hyundai', '', '', '', '37 lê văn lương', 'contact@hyundaiahau.com', '0963.369.169', '0918 01 91 91', '0938 553 228 - 0938 255 229', '0903386990', '<li><a href=\"\">NEW PORTER H150 - 1.5 Tấn</a></li>\r\n                                        <li><a href=\"\">HD270 TRỘN BÊ TÔNG</a></li>\r\n                                        <li><a href=\"\">SOLATI 16 Chỗ</a></li>\r\n                                        <li><a href=\"\">UNIVERSE 45 Chỗ</a></li>\r\n                                        <li><a href=\"\">HD270 TỰ ĐỔ</a></li>\r\n                                        <li><a href=\"\">HD320 - 17 TẤN</a></li>', '<li><a href=\"\">Chọn xe</a></li>\r\n                                        <li><a href=\"\">Đăng ký lái thử</a></li>\r\n                                        <li><a href=\"\">Khuyến mãi</a></li>\r\n                                        <li><a href=\"\">Tư vấn bảo hiểm</a></li>\r\n                                        <li><a href=\"\">Tư vấn mua xe trả góp</a></li>', '<li><a href=\"\">Cứu hộ giao thông</a></li>\r\n                                        <li><a href=\"\">Bảo dưỡng định kỳ</a></li>\r\n                                        <li><a href=\"\">Làm đẹp xe</a></li>\r\n                                        <li><a href=\"\">Dịch vụ đồng sơn</a></li>\r\n                                        <li><a href=\"\">Phụ tùng & phụ kiện chính hãng</a></li>', '', 1, '0', 'avits-mathbrtu-duy-toan-my-ixl-4-14-tuoi', 'avits-mathbrtoan'),
...
INSERT INTO `dong_xe` (`id`, `name`, `note`) VALUES
(1, 'UNIVERSE 45 chỗ', NULL),
(2, 'COUNTY 29 chỗ', NULL),
(3, 'SOLATI 16 chỗ', NULL);
...
INSERT INTO `hang_xe` (`id`, `name`, `note`) VALUES
(1, 'Kia morning', ''),
(2, 'Hyundai', ''),
(3, 'Mercedes', '');
...
--
-- Cấu trúc bảng cho bảng `lai_thu`
--

CREATE TABLE `lai_thu` (
  `id` int(11) NOT NULL,
  `dong_xe` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
--
-- Đang đổ dữ liệu cho bảng `lai_thu`
--

INSERT INTO `lai_thu` (`id`, `dong_xe`, `name`, `email`, `phone`, `note`) VALUES
(1, 'UNIVERSE 45 chỗ', 'Trương Quang Tuấn', 'tuan@gmail.com', '987654321', 'test');
...
(6, 'Trương Quang Tuấn', 'tuan@gmail.com', '987654321', '', '02-03', '2019-03-02 15:35:55');
...
(151, 'So sánh', 3, 8, 'so-sanh', 0, 0, 0, 0, 0, 1, 0, 0, 0, NULL),
(152, 'Hướng dẫn', 3, 13, '', 0, 0, 0, 36, 0, 1, 0, 0, 0, NULL),
...
(279, 'vn', 'So sánh', 0, 'so-sanh', 151),
(280, 'en', 'Lịch khám', 0, 'lich-kham', 151),
(281, 'vn', 'Hướng dẫn', 0, '', 152),
(282, 'en', 'Hướng dẫn', 0, '', 152),
...
--
-- Cấu trúc bảng cho bảng `model_xe`
--
...
--
-- Đang đổ dữ liệu cho bảng `model_xe`
--

INSERT INTO `model_xe` (`id`, `name`, `note`) VALUES
(1, 'Ceed', NULL),
(2, 'Avella', NULL),
(3, 'Bonggo', NULL);
...
(35, 35, 'vn', 'Chào mừng bạn đến với <br> <span>Hyundai Á Châu</span>', 'Thị trường xe tải ngày càng phát triển và mở rộng ra thị trường quốc tế.Hyundai Á Châu – Đại lý\r\n                        ủy quyền của Hyundai Thành Công Thương Mại được thành lập để nâng tầm phát triển về lĩnh vực các\r\n                        dòng xe Hyundai theo một hướng mới. <br>\r\n                        Xe Hyundai ngày càng khẳng định vị trí của mình trên thị trường Việt Nam. Hyundai đã cho ra mắt\r\n                        nhiều dòng xe với nhiều loại tải trọng cùng với mẫu mã đa dạng. Không chỉ phát triển ở lĩnh vực\r\n                        các dòng xe tải mà Hyundai cũng đã khẳng định vị trí của mình ở các dòng xe khách.', '<h1>C&Aacute;CH THỨC THANH TO&Aacute;N</h1>\r\n\r\n<p><img alt=\"\" src=\"http://hanoistudio.thietkewebsitegbvn.com/images/thanhtoan/1.png\" /></p>\r\n\r\n<h2>THANH TO&Aacute;N COD: NHẬN H&Agrave;NG V&Agrave; THANH TO&Aacute;N TIỀN MẶT</h2>\r\n\r\n<p>Khi qu&yacute; kh&aacute;ch y&ecirc;u cầu h&igrave;nh thức thanh to&aacute;n COD tức nhận h&agrave;ng v&agrave; thanh to&aacute;n tiền mặt, Qu&yacute; kh&aacute;ch vui l&ograve;ng lưu &yacute; những quy định sau:</p>\r\n\r\n<p>- Đối với c&aacute;c sản phẩm được giao h&agrave;ng bởi nh&acirc;n vi&ecirc;n c&ocirc;ng ty, Qu&yacute; kh&aacute;ch vui l&ograve;ng thanh to&aacute;n đầy đủ sau khi nh&acirc;n vi&ecirc;n đ&atilde; giao h&agrave;ng cho Qu&yacute; kh&aacute;ch. Nếu cần hỗ trợ hướng dẫn sử dụng, hoặc kiểm tra m&aacute;y m&oacute;c, thiết bị ch&uacute;ng t&ocirc;i sẵn s&agrave;ng hỗ trợ ngay tại chỗ.&nbsp;<br />\r\n- Đối với h&agrave;ng h&oacute;a được gởi theo đường bưu điện hoặc dịch vụ chuyển ph&aacute;t nhanh. Qu&yacute; kh&aacute;ch vui l&ograve;ng thanh to&aacute;n trước cho nh&acirc;n vi&ecirc;n giao h&agrave;ng rồi mới b&oacute;c mở h&agrave;ng h&oacute;a (Đ&acirc;y l&agrave; quy định bắt buộc của đơn vị vận chuyển). Sau khi b&oacute;c mở h&agrave;ng h&oacute;a, nếu Qu&yacute; kh&aacute;ch cần th&ecirc;m hỗ trợ g&igrave;, Qu&yacute; kh&aacute;ch vui l&ograve;ng li&ecirc;n hệ với c&ocirc;ng ty ch&uacute;ng t&ocirc;i.</p>\r\n\r\n<h2>2. THANH TO&Aacute;N QUA NH&Agrave; XE, ĐƠN VỊ CHUYỂN PH&Aacute;T</h2>\r\n\r\n<p>Đối với c&aacute;c tỉnh ở xa khu vực th&agrave;nh phố Hồ Ch&iacute; Minh hay H&agrave; Nội. Ch&uacute;ng t&ocirc;i thường lựa chọn phương thức vận chuyển bằng xe kh&aacute;ch hoặc ch&agrave;nh xe vận chuyển. Điều n&agrave;y l&agrave;m giảm chi ph&iacute; vận chuyển đ&aacute;ng kể cho kh&aacute;ch h&agrave;ng. V&igrave; những sản phẩm c&oacute; k&iacute;ch thước hoặc trọng lượng lớn gần như kh&ocirc;ng thể gởi bưu điện hoặc c&oacute; gởi cước ph&iacute; sẽ rất cao. Do đ&oacute; Qu&yacute; kh&aacute;ch lưu &yacute; một số vấn đề sau đ&acirc;y:</p>\r\n\r\n<p>- C&ocirc;ng ty sẽ &aacute;p dụng ch&iacute;nh s&aacute;ch nh&agrave; xe thu tiền hộ c&ocirc;ng ty. Do đ&oacute; nếu được y&ecirc;u cầu thu hộ, Qu&yacute; kh&aacute;ch vui l&ograve;ng chuẩn bị tiền thanh to&aacute;n trực tiếp cho nh&agrave; xe hoặc đơn vị vận chuyển do c&ocirc;ng ty y&ecirc;u cầu.&nbsp;<br />\r\n- Đối với c&aacute;c sản phẩm c&oacute; trọng lượng lớn v&agrave; kỹ thuật sử dụng phức tạp, Qu&yacute; kh&aacute;ch c&oacute; thể y&ecirc;u cầu nh&acirc;n vi&ecirc;n c&ocirc;ng ty đến tận nh&agrave; lắp đặt. V&agrave; sẽ thanh to&aacute;n cho nh&acirc;n vi&ecirc;n giao h&agrave;ng hoặc nh&acirc;n vi&ecirc;n lắp đặt t&ugrave;y theo th&ocirc;ng b&aacute;o của c&ocirc;ng ty.</p>\r\n\r\n<h2>3. THANH TO&Aacute;N TẠI C&Ocirc;NG TY</h2>\r\n\r\n<p>Qu&yacute; kh&aacute;ch mua h&agrave;ng c&oacute; thể đến địa chỉ c&ocirc;ng ty để xem h&agrave;ng v&agrave; mua h&agrave;ng:</p>\r\n\r\n<p>167 - 169 B&igrave;nh Lợi (Nơ Trang Long nối d&agrave;i), P. 13, Quận B&igrave;nh Thạnh, Tp. Hồ Ch&iacute; Minh .</p>\r\n\r\n<h2>4. THANH TO&Aacute;N C&Ocirc;NG NỢ</h2>\r\n\r\n<p>Đối với c&aacute;c c&ocirc;ng ty đề nghị thanh to&aacute;n c&ocirc;ng nợ, hai b&ecirc;n cần x&aacute;c nhận đơn đặt h&agrave;ng v&agrave; thời gian c&ocirc;ng nợ hoặc gởi PO đặt h&agrave;ng qua Email: Hotrospro@gmail.com. C&ocirc;ng ty sẽ xem x&eacute;t c&aacute;c trường hợp cụ thể v&agrave; th&ocirc;ng b&aacute;o đến kh&aacute;ch h&agrave;ng về việc c&oacute; chấp nhận c&ocirc;ng nợ hay kh&ocirc;ng.&nbsp;<br />\r\nLi&ecirc;n hệ trực tiếp qua số điện thoại: 0283 5 534 298 hoặc 0986 954 423</p>\r\n\r\n<h2>5. THANH TO&Aacute;N CHUYỂN KHOẢN</h2>\r\n\r\n<p><img alt=\"\" src=\"http://hanoistudio.thietkewebsitegbvn.com/images/thanhtoan/2.jpg\" /></p>\r\n\r\n<p>Qu&yacute; Kh&aacute;ch vui l&ograve;ng chuyển tiền v&agrave;o một trong c&aacute;c t&agrave;i khoản sau:</p>\r\n\r\n<ul>\r\n	<li>Chủ t&agrave;i khoản: C&ocirc;ng ty TNHH C&ocirc;ng Nghiệp v&agrave; Thương Mại Nam Việt&nbsp;<br />\r\n	- Số TK: 060059386363&nbsp;<br />\r\n	- Tại NH Sacombank - PGD Phan Đăng Lưu - Chi nh&aacute;nh 8/3&nbsp;</li>\r\n	<li>Chủ TK: CT TNHH C&ocirc;ng Nghiệp v&agrave; TM Nam Việt&nbsp;<br />\r\n	- Số TK: 0531002529891&nbsp;<br />\r\n	- Tại NH Vietcombank - Chi nh&aacute;nh Đ&ocirc;ng S&agrave;i G&ograve;n&nbsp;</li>\r\n	<li>Chủ TK: C&ocirc;ng ty TNHH C&ocirc;ng Nghiệp v&agrave; Thương Mại Nam Việt - Số TK: 19026579068019 - Tại NH Techcombank - Chi nh&aacute;nh Nguyễn Th&aacute;i Sơn</li>\r\n</ul>\r\n', '', '', '', '', '', 0, 'gioi-thieu', 'Giới thiệu', '', ''),
...
(37, 36, 'vn', 'Hướng dẫn', 'Bảng giá dịch thuật công chứng Giá tốt, chất lượng cao, dịch ngay\r\nHơn 8000 CTV Dịch thuật · Hơn 10 năm kinh nghiệm · 100% khách hàng hài lòng', '<h2><strong>PHƯƠNG THỨC GIAO DỊCH ĐỐI VỚI B&Aacute;O GI&Aacute; DỊCH THUẬT</strong></h2>\r\n\r\n<p>1. Ch&uacute;ng t&ocirc;i sẽ giao nhận t&agrave;i liệu tận nơi với những đơn đặt h&agrave;ng tr&ecirc;n 50 trang t&agrave;i liệu.<br />\r\n2. Để tiến h&agrave;nh c&ocirc;ng t&aacute;c dịch thuật v&agrave; phi&ecirc;n dịch Hợp đồng Qu&yacute; kh&aacute;ch cần đặt trước 30% gi&aacute; trị hợp đồng.<br />\r\n3. Nếu qu&yacute; kh&aacute;ch l&agrave; c&ocirc;ng ty c&oacute; nhu cầu dịch thuật dưới 10 trang, Qu&yacute; kh&aacute;ch chỉ cần fax x&aacute;c nhận y&ecirc;u cầu c&oacute; đầy đủ th&ocirc;ng tin li&ecirc;n quan k&egrave;m con dấu, ch&uacute;ng t&ocirc;i sẽ tiến h&agrave;nh thực hiện y&ecirc;u cầu dịch m&agrave; kh&ocirc;ng cần tiền đặt cọc hợp đồng.<br />\r\n4. Đối với kh&aacute;ch h&agrave;ng thường xuy&ecirc;n dịch tại C&ocirc;ng ty dịch thuật Ch&acirc;u &Aacute;, ch&uacute;ng t&ocirc;i sẽ giao nhận tận nơi miễn ph&iacute;.</p>\r\n\r\n<p><strong>Phần ưu ti&ecirc;n kh&aacute;ch h&agrave;ng dịch với số lượng lớn</strong><br />\r\n1. Giảm 5% với số lượng từ 100 &ndash; 500 trang<br />\r\n2. Giảm 10% với số lượng từ 500 &ndash; 1000 trang<br />\r\n3. Giảm 15% với số lượng 1000 trang trở l&ecirc;n</p>\r\n\r\n<p><strong>Lưu &yacute; quan trọng:</strong></p>\r\n\r\n<ul>\r\n	<li>Gi&aacute; dịch chưa bao gồm VAT (10%).</li>\r\n	<li>Mức gi&aacute; tr&ecirc;n kh&ocirc;ng &aacute;p dụng đối với Kh&aacute;ch h&agrave;ng dịch chuy&ecirc;n ng&agrave;nh, dịch gấp, c&ocirc;ng chứng gấp.</li>\r\n	<li>Văn bản hiệu đ&iacute;nh: Hiệu đ&iacute;nh = 50% tiền dịch. Nếu t&agrave;i liệu hiệu đ&iacute;nh sai tr&ecirc;n 30% th&igrave; bản hiệu đ&iacute;nh đ&oacute; được t&iacute;nh bằng tiền dịch.</li>\r\n	<li>Số lượng từ tr&ecirc;n một trang được quy định dưới 300 từ (D&ugrave;ng hệ thống đếm từ tự động Word Count), trường hợp t&agrave;i liệu của qu&yacute; kh&aacute;ch l&agrave; bản cứng kh&ocirc;ng thể đếm từ được sẽ t&iacute;nh x&aacute;c xuất hoặc t&iacute;nh theo bản dịch l&uacute;c n&agrave;y số lượng từ tr&ecirc;n trang sản phẩm c&oacute; thể quy định lại, th&ocirc;ng thường sẽ giao động 10-20%.</li>\r\n	<li>Gi&aacute; dịch từ tiếng nước ngo&agrave;i n&agrave;y sang tiếng nước ngo&agrave;i kh&aacute;c sẽ bằng chi ph&iacute; dịch từ tiếng nước ngo&agrave;i n&agrave;y ra tiếng Việt cộng với từ tiếng Việt sang tiếng nước ngo&agrave;i thứ hai hoặc sẽ t&iacute;nh ph&iacute; dịch trực tiếp nếu c&oacute; y&ecirc;u cầu người bản địa dịch thuật lại</li>\r\n	<li>Nếu qu&yacute; kh&aacute;ch y&ecirc;u cầu dịch gấp, dịch v&agrave;o ng&agrave;y nghỉ, ng&agrave;y lễ gi&aacute; dịch sẽ tăng 25 %, th&ocirc;ng thường đơn đặt h&agrave;ng tr&ecirc;n 20 trang lấy trong ng&agrave;y được coi l&agrave; gấp. Nếu l&agrave; kh&aacute;ch h&agrave;ng thường xuy&ecirc;n của Dịch thuật v&agrave; Phi&ecirc;n dịch Ch&acirc;u &Aacute; qu&yacute; kh&aacute;ch sẽ được miễn ph&iacute; dịch vụ cộng th&ecirc;m n&agrave;y.</li>\r\n	<li>Đối với t&agrave;i liệu chuy&ecirc;n ng&agrave;nh như: Hợp đồng kinh tế, kỹ thuật, thương mại, t&agrave;i ch&iacute;nh,y học, dược phẩm... th&igrave; ngo&agrave;i tiền dịch + 30% tiền dịch chuy&ecirc;n ng&agrave;nh.</li>\r\n</ul>\r\n\r\n<h3>BẢNG GI&Aacute; DỊCH THUẬT N&Agrave;Y C&Oacute; THỂ THAY ĐỔI PHỤ THUỘC V&Agrave;O NHU CẦU THỰC TẾ CỦA DỰ &Aacute;N, HỢP ĐỒNG V&Agrave; SỰ THỎA THUẬN GIỮA HAI B&Ecirc;N !</h3>\r\n\r\n<p>Chuyển ngữ v&agrave; địa phương h&oacute;a t&agrave;i liệu rất quan trọng n&oacute; c&oacute; ảnh hưởng rất lớn đến c&ocirc;ng việc v&agrave; quyết định trong dự &aacute;n của bạn. Qu&yacute; kh&aacute;ch đang t&igrave;m một đơn vị&nbsp;<a href=\"https://www.dichthuatchaua.com/bien-phien-dich/dich-thuat/dich-thuat-cong-chung.html\" title=\"Dịch thuật công chứng\">Dịch Thuật</a>&nbsp;chuy&ecirc;n nghiệp v&agrave; gi&agrave;u kinh nghiệm trong việc Địa phương h&oacute;a t&agrave;i liệu, đảm bảo thời gian ch&iacute;nh x&aacute;c v&agrave; chất lượng tuyệt đối, chi ph&iacute; hợp l&yacute; nhất. H&atilde;y li&ecirc;n hệ ngay với&nbsp;<a href=\"https://www.dichthuatchaua.com/gioi-thieu-cong-ty-dich-thuat.html\" title=\"Công ty dịch thuật chuyên nghiệp\">C&ocirc;ng ty dịch thuật Ch&acirc;u &Aacute;</a>&nbsp;để được nhưng chuy&ecirc;n gia tư vấn chuy&ecirc;n nghiệp, gi&agrave;u kinh nghiệm gi&uacute;p Qu&yacute; kh&aacute;ch.</p>\r\n\r\n<p><img alt=\"\" height=\"800\" src=\"/image/images/55e7557453f13-sierra-fig2.jpg\" width=\"1600\" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>Dự &aacute;n, Hợp đồng của Qu&yacute; kh&aacute;ch h&agrave;ng rất quan trọng, Qu&yacute; kh&aacute;ch h&agrave;ng đang muốn t&igrave;m một đơn vị Dịch thuật c&oacute; thể đảm bảo về thời gian, chất lượng v&agrave; cung cấp gi&aacute; cả tốt nhất, h&atilde;y li&ecirc;n lạc với số Hotline: 0932232318 (H&agrave; Nội) hoặc 0932237939 (TP HCM) của Dich thuật v&agrave; Phi&ecirc;n dịch Ch&acirc;u &Aacute; sẽ l&agrave;m Qu&yacute; kh&aacute;ch h&agrave;i l&ograve;ng.</p>\r\n\r\n<p>Cảm ơn Qu&yacute; kh&aacute;ch đ&atilde; ngh&eacute; thăm website của Dịch thuật v&agrave; Phi&ecirc;n dịch Ch&acirc;u &Aacute;, ch&uacute;ng t&ocirc;i lu&ocirc;n cam kết đưa ra mức gi&aacute; cạnh tranh v&agrave; chất lương v&agrave; bảo mật bảo đảm tuyệt đối.</p>\r\n', '', '', '', '', '', 0, 'huong-dan', 'Hướng dẫn', '', ''),
...
CREATE TABLE `product` (
  ...
  `kich_thuoc_long_thung` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `khoang_nho_truoc_sau` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `goc_nang_toi_da` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `d_r_c` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `vet_banh_xe_truoc_sau` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `chieu_dai_co_so` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ban_kinh_quay_vong_toi_thieu` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `khoang_sang_gam_xe` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `chieu_dai_dau_duoi_xe` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `goc_thoat_truoc_sau` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trong_luong_khong_tai` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trong_luong_toan_tai` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `so_cho_ngoi` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `khoi_luong_ban_than` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `khoi_luong_toan_bo` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `khoi_luong_ban_than1` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `khoi_luong_toi_da` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trong_luong_khong_tai1` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trong_luong_toan_tai1` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `khong_tai_phan_bo_cau_truoc` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `khong_tai_phan_bo_cau_sau` text COLLATE utf8_unicode_ci,
  `so_nguoi_cho_phep_chuyen_cho_ke_ca_nguoi_lai` text COLLATE utf8_unicode_ci,
  `toan_tai_phan_bo_cau_truoc` text COLLATE utf8_unicode_ci,
  `toan_tai_phan_bo_cau_sau` text COLLATE utf8_unicode_ci,
  `ban_kinh_quay_vong` text COLLATE utf8_unicode_ci,
  `ma_dong_co` text COLLATE utf8_unicode_ci,
  `cong_thuc_banh_xe` text COLLATE utf8_unicode_ci,
  `model` text COLLATE utf8_unicode_ci,
  `kieu` text COLLATE utf8_unicode_ci,
  `dong_co` text COLLATE utf8_unicode_ci,
  `loai_dong_co` text COLLATE utf8_unicode_ci,
  `duong_kinh_xi_lanh_hanh_trinh_piston` text COLLATE utf8_unicode_ci,
  `dung_tich_cong_tac` text COLLATE utf8_unicode_ci,
  `nhien_lieu` text COLLATE utf8_unicode_ci,
  `dung_tich_xy_lanh` text COLLATE utf8_unicode_ci,
  `cong_suat_cuc_dai` text COLLATE utf8_unicode_ci,
  `ty_so_nen` text COLLATE utf8_unicode_ci,
  `duong_kinh_piston_hanh_trinh_xi_lanh` text COLLATE utf8_unicode_ci,
  `momen_xoan_cuc_dai` text COLLATE utf8_unicode_ci,
  `momen_xoan_cuc_dai1` text COLLATE utf8_unicode_ci,
  `dung_tich_thung_nhien_lieu` text COLLATE utf8_unicode_ci,
  `he_thong_dan_dong` text COLLATE utf8_unicode_ci,
  `ma_hop_so` text COLLATE utf8_unicode_ci,
  `hop_so` text COLLATE utf8_unicode_ci,
  `loai_hop_so` text COLLATE utf8_unicode_ci,
  `ban_kinh_quay_vong1` text COLLATE utf8_unicode_ci,
  `kha_nang_vuot_doc` text COLLATE utf8_unicode_ci,
  `ban_kinh_vong_quay_toi_thieu` text COLLATE utf8_unicode_ci,
  `van_toc_toi_da` text COLLATE utf8_unicode_ci,
  `kha_nang_leo_doc_toi_da` text COLLATE utf8_unicode_ci,
  `tai_trong_cau_truoc` text COLLATE utf8_unicode_ci,
  `tai_trong_cau_sau` text COLLATE utf8_unicode_ci,
  `hop_so1` text COLLATE utf8_unicode_ci,
  `loai_hop_so1` text COLLATE utf8_unicode_ci,
  `lop` text COLLATE utf8_unicode_ci,
  `truoc` text COLLATE utf8_unicode_ci,
  `sau` text COLLATE utf8_unicode_ci,
  `lop_truoc_sau` text COLLATE utf8_unicode_ci,
  `kieu_lop_xe` text COLLATE utf8_unicode_ci,
  `co_vanh` text COLLATE utf8_unicode_ci,
  `co_lop_xe` text COLLATE utf8_unicode_ci,
  `chat_lieu_lazang` text COLLATE utf8_unicode_ci,
  `lop_du_phong` text COLLATE utf8_unicode_ci,
  `thong_so_lop` text COLLATE utf8_unicode_ci,
  `loai_vanh` text COLLATE utf8_unicode_ci,
  `kich_thuoc_lop` text COLLATE utf8_unicode_ci,
  `he_thong_phanh` text COLLATE utf8_unicode_ci,
  `he_thong_phanh_phu_khi_xa` text COLLATE utf8_unicode_ci,
  `he_thong_phanh_phu_jake` text COLLATE utf8_unicode_ci,
  `abs_asr` text COLLATE utf8_unicode_ci,
  `he_thong_treo_truoc_sau` text COLLATE utf8_unicode_ci,
  `he_thong_lai` text COLLATE utf8_unicode_ci,
  `hop_de_dung_cu` text COLLATE utf8_unicode_ci,
  `thiet_bi_gps` text COLLATE utf8_unicode_ci,
  `radio_aux` text COLLATE utf8_unicode_ci,
  `dong_ho_toc_do` text COLLATE utf8_unicode_ci,
  `the_tich_khoang_hanh_ly` text COLLATE utf8_unicode_ci,
  `tu_lanh` text COLLATE utf8_unicode_ci,
  `he_thong_audio` text COLLATE utf8_unicode_ci,
  `hoc_de_kinh` text COLLATE utf8_unicode_ci,
  `ho_tro_tua_lung` text COLLATE utf8_unicode_ci,
  `vo_lang_dieu_trinh_len_xuong` text COLLATE utf8_unicode_ci,
  `cua_gio_den_doc_sach_tung_hang_ghe` text COLLATE utf8_unicode_ci,
  `tay_lai_tro_luc` text COLLATE utf8_unicode_ci,
  `dieu_hoa_nhiet_do` text COLLATE utf8_unicode_ci,
  `truoc1` text COLLATE utf8_unicode_ci,
  `sau1` text COLLATE utf8_unicode_ci,
  `product_compare` int(11) NOT NULL,
  `product_weight` int(11) NOT NULL,
  `product_menu` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `product` (`product_id`, `product_name`, `product_des`, `product_des2`, `product_des3`, `product_content`, `product_content2`, `product_content3`, `product_price`, `product_price_sale`, `product_discount`, `product_img`, `product_sub_img`, `product_created_date`, `product_update_date`, `productcat_id`, `product_hot`, `product_favorite`, `product_new`, `product_sale`, `product_code`, `product_original`, `product_size`, `product_package`, `product_delivery`, `product_delivery_time`, `product_payment`, `product_payment_type`, `product_sub_info1`, `product_sub_info2`, `product_sub_info3`, `product_sub_info4`, `product_sub_info5`, `state`, `title_seo`, `des_seo`, `friendly_url`, `keyword`, `created_id`, `product_material`, `product_shape`, `product_expiration`, `product_producer`, `product_review`, `productcat_ar`, `product_brand`, `product_sex`, `product_size_arr`, `kich_thuoc_long_thung`, `khoang_nho_truoc_sau`, `goc_nang_toi_da`, `d_r_c`, `vet_banh_xe_truoc_sau`, `chieu_dai_co_so`, `ban_kinh_quay_vong_toi_thieu`, `khoang_sang_gam_xe`, `chieu_dai_dau_duoi_xe`, `goc_thoat_truoc_sau`, `trong_luong_khong_tai`, `trong_luong_toan_tai`, `so_cho_ngoi`, `khoi_luong_ban_than`, `khoi_luong_toan_bo`, `khoi_luong_ban_than1`, `khoi_luong_toi_da`, `trong_luong_khong_tai1`, `trong_luong_toan_tai1`, `khong_tai_phan_bo_cau_truoc`, `khong_tai_phan_bo_cau_sau`, `so_nguoi_cho_phep_chuyen_cho_ke_ca_nguoi_lai`, `toan_tai_phan_bo_cau_truoc`, `toan_tai_phan_bo_cau_sau`, `ban_kinh_quay_vong`, `ma_dong_co`, `cong_thuc_banh_xe`, `model`, `kieu`, `dong_co`, `loai_dong_co`, `duong_kinh_xi_lanh_hanh_trinh_piston`, `dung_tich_cong_tac`, `nhien_lieu`, `dung_tich_xy_lanh`, `cong_suat_cuc_dai`, `ty_so_nen`, `duong_kinh_piston_hanh_trinh_xi_lanh`, `momen_xoan_cuc_dai`, `momen_xoan_cuc_dai1`, `dung_tich_thung_nhien_lieu`, `he_thong_dan_dong`, `ma_hop_so`, `hop_so`, `loai_hop_so`, `ban_kinh_quay_vong1`, `kha_nang_vuot_doc`, `ban_kinh_vong_quay_toi_thieu`, `van_toc_toi_da`, `kha_nang_leo_doc_toi_da`, `tai_trong_cau_truoc`, `tai_trong_cau_sau`, `hop_so1`, `loai_hop_so1`, `lop`, `truoc`, `sau`, `lop_truoc_sau`, `kieu_lop_xe`, `co_vanh`, `co_lop_xe`, `chat_lieu_lazang`, `lop_du_phong`, `thong_so_lop`, `loai_vanh`, `kich_thuoc_lop`, `he_thong_phanh`, `he_thong_phanh_phu_khi_xa`, `he_thong_phanh_phu_jake`, `abs_asr`, `he_thong_treo_truoc_sau`, `he_thong_lai`, `hop_de_dung_cu`, `thiet_bi_gps`, `radio_aux`, `dong_ho_toc_do`, `the_tich_khoang_hanh_ly`, `tu_lanh`, `he_thong_audio`, `hoc_de_kinh`, `ho_tro_tua_lung`, `vo_lang_dieu_trinh_len_xuong`, `cua_gio_den_doc_sach_tung_hang_ghe`, `tay_lai_tro_luc`, `dieu_hoa_nhiet_do`, `truoc1`, `sau1`, `product_compare`, `product_weight`, `product_menu`) VALUES
(36, 'Latin words, combined', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 7600000, 10, 0, 'product4.jpg', '[]', '2017-05-22 00:05:50', '2018-11-14 15:11:23', 0, 1, 0, 0, 0, '01', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'Latin words, combined', '', 'latin-words-combined', '', NULL, 'Vải bóng', 'Cổ điển', '3 năm', 4, NULL, '139,139', 2, 1, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(37, 'It uses a dictionary', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 135000, 0, 0, 'product3.jpg', '[\"{\\\"image\\\":\\\"7_12.jpg\\\"}\",\"{\\\"image\\\":\\\"7_8.jpg\\\"}\",\"{\\\"image\\\":\\\"7_6.jpg\\\"}\",\"{\\\"image\\\":\\\"7_5.jpg\\\"}\",\"{\\\"image\\\":\\\"7_3_0.jpg\\\"}\"]', '2017-05-22 00:05:55', '2018-11-14 15:11:02', 0, 1, 0, 0, 0, '01', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'It uses a dictionary', '', 'it-uses-a-dictionary', '', NULL, 'Giấy dán', 'Khổ đứng', '5 năm', NULL, NULL, '139,139', 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(38, 'generator on the Internet', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 135000, 0, 0, 'product2.jpg', '[]', '2017-05-22 00:05:39', '2018-11-14 15:11:39', 0, 1, 0, 0, 0, '01', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'generator on the Internet', '', 'generator-on-the-internet', '', NULL, 'Giấy dán', 'Khổ đứng', '5 năm', NULL, NULL, '139,139', 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(39, 'making this the first true', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 135000, 0, 0, 'product1.jpg', '[]', '2017-05-22 00:05:13', '2018-11-14 15:11:19', 0, 1, 0, 0, 0, '01', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'making this the first true', '', 'making-this-the-first-true', '', NULL, 'Giấy dán', 'Khổ đứng', '5 năm', NULL, NULL, '139,139', 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(40, 'repeat predefined chunks', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 135000, 0, 0, 'product8.jpg', '[]', '2017-05-22 00:05:53', '2018-11-14 15:11:57', 0, 1, 0, 0, 0, '01', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'repeat predefined chunks', '', 'repeat-predefined-chunks', '', NULL, 'Giấy dán', 'Khổ đứng', '5 năm', NULL, NULL, '139,139', 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(41, 'on the Internet tend', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 13500000, 15, 0, 'product7.jpg', '[]', '2017-05-22 00:05:31', '2018-11-14 15:11:35', 0, 1, 0, 1, 0, '01', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'on the Internet tend', '', 'on-the-internet-tend', '', NULL, 'Giấy dán', 'Khổ đứng', '5 năm', NULL, NULL, '139,139', 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(42, 'All the Lorem Ipsum generators', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 205000, 0, 0, 'product6.jpg', '[]', '2017-07-09 18:07:02', '2018-11-14 15:11:13', 0, 1, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'All the Lorem Ipsum generators', '', 'all-the-lorem-ipsum-generators', '', 1, '', '', '', NULL, NULL, NULL, 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(43, 'middle of text', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 225000, 0, 0, 'product5.jpg', '[]', '2017-07-09 18:07:18', '2018-11-14 15:11:52', 0, 0, 0, 1, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'middle of text', '', 'middle-of-text', '', 1, '', '', '', NULL, NULL, NULL, 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(44, 'there isn\'t anything embarrassing', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 180000, 0, 0, 'product4.jpg', '[]', '2017-07-09 18:07:07', '2018-11-14 15:11:33', 0, 1, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'there isn\'t anything embarrassing', '', 'there-isnt-anything-embarrassing', '', 1, '', '', '', NULL, NULL, NULL, 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(45, 'a passage of Lorem', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 225000, 0, 0, 'product3.jpg', '[]', '2017-07-09 18:07:18', '2018-11-14 15:11:09', 0, 0, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'a passage of Lorem', '', 'a-passage-of-lorem', '', 1, '', '', '', NULL, NULL, NULL, 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(46, 'you are going to', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 55000, 0, 0, 'product2.jpg', '[]', '2017-07-09 18:07:29', '2018-11-14 15:11:22', 0, 0, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 1, 'you are going to', '', 'you-are-going-to', '', 1, '', '', '', NULL, NULL, NULL, 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(47, 'slightly believable', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<h3>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</h3>\r\n\r\n<p style=\"text-align:center\"><img alt=\"\" height=\"501\" src=\"/image/images/americanskills/xem_b_ng__i_m_chi_ti_t_c_a_h_c_sinh.png\" width=\"617\" /></p>\r\n', '', '', 100000, 0, 0, 'product1.jpg', '[]', '2017-07-09 18:07:40', '2018-11-14 15:11:02', 0, 0, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'slightly believable', '', 'slightly-believable', '', 1, '', '', '', NULL, NULL, NULL, 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
(48, 'which don\'t look even', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 799000, 0, 0, 'product8.jpg', '[]', '2017-07-11 00:07:31', '2019-03-02 23:03:36', 0, 0, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'which don\'t look even', '', 'which-dont-look-even', '', 1, '', '', '', NULL, NULL, '140,140', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, '', NULL, NULL, '', '', '', '', NULL, '', '', '', '', 0, 1, 1),
(49, 'randomised words', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 0, 0, 0, 'product7.jpg', '[\"{\\\"image\\\":\\\"thumb_14665040398269_13393977_585369601636975_3431445518694990846_n.jpg\\\"}\",\"{\\\"image\\\":\\\"thumb_14665040415616_13407078_585370381636897_427809477680829256_n.jpg\\\"}\",\"{\\\"image\\\":\\\"thumb_14665040419321_13417435_585370258303576_3636360098352839377_n.jpg\\\"}\",\"{\\\"image\\\":\\\"thumb_14665040423295_13418747_585369251637010_3247308734397122599_n.jpg\\\"}\"]', '2017-07-11 00:07:45', '2019-03-02 23:03:22', 0, 0, 0, 1, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'randomised words', '', 'randomised-words', '', 1, '', '', '', NULL, NULL, '140,140', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, '', NULL, NULL, '', '', '', '', NULL, '', '', '', '', 0, 1, 1),
(50, 'injected humour', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 0, 0, 0, 'product6.jpg', '[\"{\\\"image\\\":\\\"logo.png\\\"}\",\"{\\\"image\\\":\\\"fastrackids-3-460.png\\\"}\",\"{\\\"image\\\":\\\"tuyen-dung-nhan-vien-phu-trach-xuat-ban-sach-toan-hoc.jpg\\\"}\",\"{\\\"image\\\":\\\"thong-tin-tuyen-dung1.jpg\\\"}\",\"{\\\"image\\\":\\\"Le Ngoc Trang_TOEIC 820.jpg\\\"}\"]', '2017-09-21 23:09:49', '2019-03-02 23:03:11', 0, 0, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'injected humour', '', 'injected-humour', '', 1, '', '', '', NULL, NULL, '140,140', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, '', NULL, NULL, '', '', '', '', NULL, '', '', '', '', 0, 1, 1),
(51, 'alteration in some form', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 1400000, 0, 0, 'product5.jpg', '[]', '2018-03-28 08:03:53', '2019-03-02 23:03:00', 0, 1, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 1, 'alteration in some form', '', 'alteration-in-some-form', '', 1, '', '', '', NULL, NULL, '140,140', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, '', NULL, NULL, '', '', '', '', NULL, '', '', '', '', 0, 1, 1),
(52, 'the majority have suffered', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 700000000, 0, 0, 'product4.jpg', '[]', '2018-03-28 13:03:43', '2019-03-02 20:03:53', 0, 1, 0, 0, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'the majority have suffered', '', 'the-majority-have-suffered', '', 1, '', '', '', NULL, NULL, '140,140', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, '', NULL, NULL, '', '', '', '', NULL, '', '', '', '', 0, 1, 0),
(53, 'Lorem Ipsum available', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 0, 0, 0, 'product3.jpg', '[]', '2018-03-28 13:03:34', '2019-03-01 21:03:08', 0, 1, 0, 1, 0, '', '', '[]', '', '', '', '', '', '', '', '', '', '', 0, 'Lorem Ipsum available', '', 'lorem-ipsum-available', '', 1, '', '', '', NULL, NULL, '140,140', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '321', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, '', NULL, NULL, '', '', '', '', NULL, '', '', '', '', 1, 0, 0),
(54, 'variations of passages', '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>\r\n', '', '', '<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>\r\n', '', '', 5000, 0, 0, 'product2.jpg', '[]', '2018-03-28 13:03:36', '2019-03-02 01:03:01', 0, 1, 0, 0, 0, '', '', '[]', '', '', '', '', '', '<p>1</p>\r\n', '<p>2</p>\r\n', '<p>3</p>\r\n', '', '', 0, 'variations of passages', '', 'variations-of-passages', '', 1, '', '', '', NULL, NULL, '140,140', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '123', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '2', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, '', NULL, NULL, '', '', '', '', NULL, '', '', '', '', 1, 1, 0),
(55, 'There are many', '<p>This stylish hamper is a wonderful way to welcome a new baby into the world. Little Pink Bunny is a gorgeously soft and snuggly friend, she is so huggably, hoppily soft she makes the perfect bedtime buddy. The hamper also contains our award winning, all-natural skincare, designed specifically for a newborn baby’s delicate skin and this gift hamper is finished with our stunning baby bud posy containing six pairs of fabulous stay-on socks.tu</p>\r\n', '', '', '<p>This welcome hamper contains: The lovely Little Pink Bunny with pretty pink trim and a rattle, perfect for sensory play. She is 24 cm high and suitable from birth. <br />\r\nOne 150ml moisturising baby lotion. This is a soothing, fragrance free lotion designed especially for a baby’s delicate skin. Handmade in Cornwall using no parabens, sodium lauryl sulphate, fragrances, palm oil or lanolin the all-natural ingredients include beeswax, wheatgerm, honey and evening primrose oil. <br />\r\nOne 60ml baby care cream. This is our most popular cream and mums love how effective it is on everything from nappy rash to eczema. Again, handmade in Cornwall and completely natural it contains calendula to soothe and reduce redness, lavender for relaxation and its antiseptic properties, wheat germ to soothe and rejuvenate and finally honey for its ability to attract and maintain moisture, helping to soften and protect delicate skin. <br />\r\nOne baby bud posy – the six pairs of ‘stay on’ socks within the posy contain 67% cotton, 29% nylon, 4% spandex. <br />\r\nPerfectly packaged in a beautifully illustrated gift box with a gift card bearing your message, this is a wonderful gift for a new mum. tu</p>\r\n\r\n<p>Đặc biệt, chúng tôi luôn cập nhật các sản phẩm công nghệ mới và luôn có các chương trình khuyến mãi đặc sắc: giá cả ưu đãi, quà tặng phong phú tới Khách hàng.</p>\r\n', '', '', 379000000, 100000000, 0, 'product1.jpg', '[\"{\\\"image\\\":\\\"product2.jpg\\\"}\"]', '2018-03-28 13:03:01', '2019-03-02 23:03:27', 0, 0, 0, 0, 0, '', '', '[]', '', '', '', '', '', '<p>1</p>\r\n', '<p>2</p>\r\n', '<p>3</p>\r\n', '', '', 0, 'There are many', '', 'there-are-many', '', 1, '', '', '', NULL, NULL, '140,140', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '28', '', '30', '', '', '33', '', '', '36', '37', '38', '', '40', '', '', '', '3', '', '', '', '', '', '', '', '', '', '', '', '56', '57', '', '', '60', '61', '', '', '', '65', '', '', '', '', '', '', '', '73', NULL, NULL, '74', NULL, NULL, '75', '76', '77', '78', NULL, '79', '80', '81', '82', 1, 1, 1);
...
--
-- Cấu trúc bảng cho bảng `tra_gop`
--
...
CREATE TABLE `tra_gop` (
  ...
  `money_mua` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `hang_xe` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `model_xe` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `year` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `money_vay` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `time_vay` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `at` text CHARACTER SET utf8 COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Đang đổ dữ liệu cho bảng `tra_gop`
--

INSERT INTO `tra_gop` (`id`, `name`, `phone`, `email`, `city`, `money_mua`, `hang_xe`, `model_xe`, `year`, `money_vay`, `time_vay`, `at`) VALUES
(1, 'Trương Quang Tuấn', '0987654321', 'tuan@gmail.com', 'Hải Phòng', '379,000,000', 'Kia morning', 'Avella', '2015', '500,000,000', '60', 'Chưa chốt vay mua, đang tham khảo lãi suất');
...
--
-- Chỉ mục cho bảng `model_xe`
--
ALTER TABLE `model_xe`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT cho bảng `lai_thu`
--
ALTER TABLE `lai_thu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT cho bảng `model_xe`
--
ALTER TABLE `model_xe`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT cho bảng `tra_gop`
--
ALTER TABLE `tra_gop`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
