...
?>
<div class="gb-recenpost-sidebar-nissan widget-sidebar">
    <aside class="widget">
        <h3 class="widget-title-sidebar-nissan">Bài viết mới nhất</h3>
        <div class="widget-content">
            <div class="gb-blog-left-recent-posts_nissan">
                <ul>
                    <?php 
                    ...
                    ?>
                    <li>
                        <div class="gb-item-recent-posts_nissan">
                            <div class="gb-item-recent-posts_nissan-img">
                                <a href="/<?= $rowLang['friendly_url'] ?>"><img src="/images/<?= $item['news_img'] ?>" alt="new"></a>
                            </div>
                            <div class="gb-item-recent-posts_nissan-text">
                                <h2><a href="/<?= $rowLang['friendly_url'] ?>"><?= $rowLang['lang_news_name'] ?></a></h2>
                                <div class="gb-item-recent-post-time_nissan">
