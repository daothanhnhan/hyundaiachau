...
<div class="gb-single-blog_nissan">
    <div class="container">
        <div class="row">
            <div class="col-md-8 gb-single-blog_nissan-right">
                <div class="gb-single-blog_nissan-right-img">
                    <img src="/images/<?= $row['news_img'] ?>" alt="<?= $rowLang['lang_news_name'] ?>" class="img-responsive">
                </div>
                <div class="gb-single-blog_nissan-right-title">
                    <h2><?= $rowLang['lang_news_name'] ?></h2>
                </div>
                <div class="gb-single-blog_nissan-right-info">
                    <ul>
                ...
                <div class="gb-single-blog_nissan-right-text">
                    <?= $rowLang['lang_news_content'] ?>
                </div>

                <div class="gb-single-blog_nissan-share">
                    <div class="row">
                        <div class="col-md-5 gb-single-blog_nissan-share-left">
                            <ul>
                        ...
                        <div class="col-md-5 col-md-offset-2 gb-single-blog_nissan-share-right">
                            <ul>
                ...
                <!--bình luận-->
                <?php include DIR_EMAIL."MS_EMAIL_NISSAN_0002.php";?>

                <!--tin tức liên quan-->
                <?php include DIR_NEWS."MS_NEWS_NISSAN_0003.php";?>
