        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    /////////////// hang xe ///////////////
                    case "hang-xe":
                        include_once("template/hang-xe/hang-xe.php");
                        break;
                    case "them-hang-xe":
                        include_once("template/hang-xe/them-hang-xe.php");
                        break;
                    case "sua-hang-xe":
                        include_once("template/hang-xe/sua-hang-xe.php");
                        break;
                    case "xoa-hang-xe":
                        include_once("template/hang-xe/xoa-hang-xe.php");
                        break;
                    //////////////// model xe /////////////
                    case "model-xe":
                        include_once("template/model-xe/model-xe.php");
                        break;
                    case "them-model-xe":
                        include_once("template/model-xe/them-model-xe.php");
                        break;
                    case "sua-model-xe":
                        include_once("template/model-xe/sua-model-xe.php");
                        break;
                    case "xoa-model-xe":
                        include_once("template/model-xe/xoa-model-xe.php");
                        break;
                    ///////////////// dòng xe /////////////
                    case "dong-xe":
                        include_once("template/dong-xe/dong-xe.php");
                        break;
                    case "them-dong-xe":
                        include_once("template/dong-xe/them-dong-xe.php");
                        break;
                    case "sua-dong-xe":
                        include_once("template/dong-xe/sua-dong-xe.php");
                        break;
                    case "xoa-dong-xe":
                        include_once("template/dong-xe/xoa-dong-xe.php");
                        break;
                    /////////////// tra góp ///////////////
                    case "tra-gop":
                        include_once("template/tra-gop/tra-gop.php");
                        break;
                    case "xoa-tra-gop":
                        include_once("template/tra-gop/xoa-tra-gop.php");
                        break;
                    ///////////// dang ky lai thu /////////
                    case "lai-thu":
                        include_once("template/lai-thu/lai-thu.php");
                        break;
                    case "xoa-lai-thu":
                        include_once("template/lai-thu/xoa-lai-thu.php");
                        break;
                    ///////////// Default /////////////////
                    default:
