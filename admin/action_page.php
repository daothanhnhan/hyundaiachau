...
class action_page extends library{
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$kich_thuoc_long_thung = isset($_POST['kich_thuoc_long_thung']) ? $_POST['kich_thuoc_long_thung'] : '';

			$khoang_nho_truoc_sau = isset($_POST['khoang_nho_truoc_sau']) ? $_POST['khoang_nho_truoc_sau'] : '';

			$goc_nang_toi_da = isset($_POST['goc_nang_toi_da']) ? $_POST['goc_nang_toi_da'] : '';

			$d_r_c = isset($_POST['d_r_c']) ? $_POST['d_r_c'] : '';

			$vet_banh_xe_truoc_sau = isset($_POST['vet_banh_xe_truoc_sau']) ? $_POST['vet_banh_xe_truoc_sau'] : '';

			$chieu_dai_co_so = isset($_POST['chieu_dai_co_so']) ? $_POST['chieu_dai_co_so'] : '';

			$ban_kinh_quay_vong_toi_thieu = isset($_POST['ban_kinh_quay_vong_toi_thieu']) ? $_POST['ban_kinh_quay_vong_toi_thieu'] : '';

			$khoang_sang_gam_xe = isset($_POST['khoang_sang_gam_xe']) ? $_POST['khoang_sang_gam_xe'] : '';

			$chieu_dai_dau_duoi_xe = isset($_POST['chieu_dai_dau_duoi_xe']) ? $_POST['chieu_dai_dau_duoi_xe'] : '';

			$goc_thoat_truoc_sau = isset($_POST['goc_thoat_truoc_sau']) ? $_POST['goc_thoat_truoc_sau'] : '';

			$trong_luong_khong_tai = isset($_POST['trong_luong_khong_tai']) ? $_POST['trong_luong_khong_tai'] : '';

			$trong_luong_toan_tai = isset($_POST['trong_luong_toan_tai']) ? $_POST['trong_luong_toan_tai'] : '';

			$so_cho_ngoi = isset($_POST['so_cho_ngoi']) ? $_POST['so_cho_ngoi'] : '';

			$khoi_luong_ban_than = isset($_POST['khoi_luong_ban_than']) ? $_POST['khoi_luong_ban_than'] : '';

			$khoi_luong_toan_bo = isset($_POST['khoi_luong_toan_bo']) ? $_POST['khoi_luong_toan_bo'] : '';			

			/////////// khoi luong

			$khoi_luong_ban_than1 = isset($_POST['khoi_luong_ban_than1']) ? $_POST['khoi_luong_ban_than1'] : '';

			$khoi_luong_toi_da = isset($_POST['khoi_luong_toi_da']) ? $_POST['khoi_luong_toi_da'] : '';

			$trong_luong_khong_tai1 = isset($_POST['trong_luong_khong_tai1']) ? $_POST['trong_luong_khong_tai1'] : '';

			$trong_luong_toan_tai1 = isset($_POST['trong_luong_toan_tai1']) ? $_POST['trong_luong_toan_tai1'] : '';

			$khong_tai_phan_bo_cau_truoc = isset($_POST['khong_tai_phan_bo_cau_truoc']) ? $_POST['khong_tai_phan_bo_cau_truoc'] : '';

			$khong_tai_phan_bo_cau_sau = isset($_POST['khong_tai_phan_bo_cau_sau']) ? $_POST['khong_tai_phan_bo_cau_sau'] : '';

			$so_nguoi_cho_phep_chuyen_cho_ke_ca_nguoi_lai = isset($_POST['so_nguoi_cho_phep_chuyen_cho_ke_ca_nguoi_lai']) ? $_POST['so_nguoi_cho_phep_chuyen_cho_ke_ca_nguoi_lai'] : '';

			$toan_tai_phan_bo_cau_truoc = isset($_POST['toan_tai_phan_bo_cau_truoc']) ? $_POST['toan_tai_phan_bo_cau_truoc'] : '';

			$toan_tai_phan_bo_cau_sau = isset($_POST['toan_tai_phan_bo_cau_sau']) ? $_POST['toan_tai_phan_bo_cau_sau'] : '';

			$ban_kinh_quay_vong = isset($_POST['ban_kinh_quay_vong']) ? $_POST['ban_kinh_quay_vong'] : '';

			////////// dong co

			$ma_dong_co = isset($_POST['ma_dong_co']) ? $_POST['ma_dong_co'] : '';

			$cong_thuc_banh_xe = isset($_POST['cong_thuc_banh_xe']) ? $_POST['cong_thuc_banh_xe'] : '';

			$model = isset($_POST['model']) ? $_POST['model'] : '';

			$kieu = isset($_POST['kieu']) ? $_POST['kieu'] : '';

			$dong_co = isset($_POST['dong_co']) ? $_POST['dong_co'] : '';

			$loai_dong_co = isset($_POST['loai_dong_co']) ? $_POST['loai_dong_co'] : '';

			$duong_kinh_xi_lanh_hanh_trinh_piston = isset($_POST['duong_kinh_xi_lanh_hanh_trinh_piston']) ? $_POST['duong_kinh_xi_lanh_hanh_trinh_piston'] : '';

			$dung_tich_cong_tac = isset($_POST['dung_tich_cong_tac']) ? $_POST['dung_tich_cong_tac'] : '';

			$nhien_lieu = isset($_POST['nhien_lieu']) ? $_POST['nhien_lieu'] : '';

			$dung_tich_xy_lanh = isset($_POST['dung_tich_xy_lanh']) ? $_POST['dung_tich_xy_lanh'] : '';

			$cong_suat_cuc_dai = isset($_POST['cong_suat_cuc_dai']) ? $_POST['cong_suat_cuc_dai'] : '';

			$ty_so_nen = isset($_POST['ty_so_nen']) ? $_POST['ty_so_nen'] : '';

			$duong_kinh_piston_hanh_trinh_xi_lanh = isset($_POST['duong_kinh_piston_hanh_trinh_xi_lanh']) ? $_POST['duong_kinh_piston_hanh_trinh_xi_lanh'] : '';

			$momen_xoan_cuc_dai = isset($_POST['momen_xoan_cuc_dai']) ? $_POST['momen_xoan_cuc_dai'] : '';

			$momen_xoan_cuc_dai1 = isset($_POST['momen_xoan_cuc_dai1']) ? $_POST['momen_xoan_cuc_dai1'] : '';

			$dung_tich_thung_nhien_lieu = isset($_POST['dung_tich_thung_nhien_lieu']) ? $_POST['dung_tich_thung_nhien_lieu'] : '';

			///////// he thong dan dong

			$he_thong_dan_dong = isset($_POST['he_thong_dan_dong']) ? $_POST['he_thong_dan_dong'] : '';

			///////// hộp số 

			$ma_hop_so = isset($_POST['ma_hop_so']) ? $_POST['ma_hop_so'] : '';

			$hop_so = isset($_POST['hop_so']) ? $_POST['hop_so'] : '';

			$loai_hop_so = isset($_POST['loai_hop_so']) ? $_POST['loai_hop_so'] : '';

			///////// đăc tinh van hanh

			$ban_kinh_quay_vong1 = isset($_POST['ban_kinh_quay_vong1']) ? $_POST['ban_kinh_quay_vong1'] : '';

			$kha_nang_vuot_doc = isset($_POST['kha_nang_vuot_doc']) ? $_POST['kha_nang_vuot_doc'] : '';

			$ban_kinh_vong_quay_toi_thieu = isset($_POST['ban_kinh_vong_quay_toi_thieu']) ? $_POST['ban_kinh_vong_quay_toi_thieu'] : '';

			$van_toc_toi_da = isset($_POST['van_toc_toi_da']) ? $_POST['van_toc_toi_da'] : '';

			$kha_nang_leo_doc_toi_da = isset($_POST['kha_nang_leo_doc_toi_da']) ? $_POST['kha_nang_leo_doc_toi_da'] : '';

			///////// cau 

			$tai_trong_cau_truoc = isset($_POST['tai_trong_cau_truoc']) ? $_POST['tai_trong_cau_truoc'] : '';

			$tai_trong_cau_sau = isset($_POST['tai_trong_cau_sau']) ? $_POST['tai_trong_cau_sau'] : '';

			//////// truyen dong / lop

			$hop_so1 = isset($_POST['hop_so1']) ? $_POST['hop_so1'] : '';

			$loai_hop_so1 = isset($_POST['loai_hop_so1']) ? $_POST['loai_hop_so1'] : '';

			$lop = isset($_POST['lop']) ? $_POST['lop'] : '';

			//////// he thong treo

			$truoc = isset($_POST['truoc']) ? $_POST['truoc'] : '';

			$sau = isset($_POST['sau']) ? $_POST['sau'] : '';

			//////// vành lốp xe

			$lop_truoc_sau = isset($_POST['lop_truoc_sau']) ? $_POST['lop_truoc_sau'] : '';

			$kieu_lop_xe = isset($_POST['kieu_lop_xe']) ? $_POST['kieu_lop_xe'] : '';

			$co_vanh = isset($_POST['co_vanh']) ? $_POST['co_vanh'] : '';

			$co_lop_xe = isset($_POST['co_lop_xe']) ? $_POST['co_lop_xe'] : '';

			$chat_lieu_lazang = isset($_POST['chat_lieu_lazang']) ? $_POST['chat_lieu_lazang'] : '';

			$lop_du_phong = isset($_POST['lop_du_phong']) ? $_POST['lop_du_phong'] : '';

			$thong_so_lop = isset($_POST['thong_so_lop']) ? $_POST['thong_so_lop'] : '';

			$loai_vanh = isset($_POST['loai_vanh']) ? $_POST['loai_vanh'] : '';

			$kich_thuoc_lop = isset($_POST['kich_thuoc_lop']) ? $_POST['kich_thuoc_lop'] : '';

			//////// hệ thống phanh - treo

			$he_thong_phanh = isset($_POST['he_thong_phanh']) ? $_POST['he_thong_phanh'] : '';

			$he_thong_phanh_phu_khi_xa = isset($_POST['he_thong_phanh_phu_khi_xa']) ? $_POST['he_thong_phanh_phu_khi_xa'] : '';

			$he_thong_phanh_phu_jake = isset($_POST['he_thong_phanh_phu_jake']) ? $_POST['he_thong_phanh_phu_jake'] : '';

			$abs_asr = isset($_POST['abs_asr']) ? $_POST['abs_asr'] : '';

			$he_thong_treo_truoc_sau = isset($_POST['he_thong_treo_truoc_sau']) ? $_POST['he_thong_treo_truoc_sau'] : '';

			$he_thong_lai = isset($_POST['he_thong_lai']) ? $_POST['he_thong_lai'] : '';

			//////// các trang bị khác

			$hop_de_dung_cu = isset($_POST['hop_de_dung_cu']) ? $_POST['hop_de_dung_cu'] : '';

			$dong_ho_toc_do = isset($_POST['dong_ho_toc_do']) ? $_POST['dong_ho_toc_do'] : '';

			$he_thong_audio = isset($_POST['he_thong_audio']) ? $_POST['he_thong_audio'] : '';

			$hoc_de_kinh = isset($_POST['hoc_de_kinh']) ? $_POST['hoc_de_kinh'] : '';

			$ho_tro_tua_lung = isset($_POST['ho_tro_tua_lung']) ? $_POST['ho_tro_tua_lung'] : '';

			$vo_lang_dieu_trinh_len_xuong = isset($_POST['vo_lang_dieu_trinh_len_xuong']) ? $_POST['vo_lang_dieu_trinh_len_xuong'] : '';

			$tay_lai_tro_luc = isset($_POST['tay_lai_tro_luc']) ? $_POST['tay_lai_tro_luc'] : '';

			$dieu_hoa_nhiet_do = isset($_POST['dieu_hoa_nhiet_do']) ? $_POST['dieu_hoa_nhiet_do'] : '';

			//////// phanh

			$truoc1 = isset($_POST['truoc1']) ? $_POST['truoc1'] : '';

			$sau1 = isset($_POST['sau1']) ? $_POST['sau1'] : '';

			///////

			$product_compare = isset($_POST['product_compare']) ? $_POST['product_compare'] : '0';

			$product_weight = isset($_POST['product_weight']) ? $_POST['product_weight'] : '0';
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   array('product_name', 
								  		...
								  		'kich_thuoc_long_thung',

								  		'khoang_nho_truoc_sau',

								  		'goc_nang_toi_da',

								  		'd_r_c',

								  		'vet_banh_xe_truoc_sau',
								  		...
								  		'khoi_luong_ban_than1',

								  		'khoi_luong_toi_da',

								  		'trong_luong_khong_tai1',

								  		'trong_luong_toan_tai1',

								  		'khong_tai_phan_bo_cau_truoc',

								  		'khong_tai_phan_bo_cau_sau',

								  		'so_nguoi_cho_phep_chuyen_cho_ke_ca_nguoi_lai',

								  		'toan_tai_phan_bo_cau_truoc',

								  		'toan_tai_phan_bo_cau_sau',
								  		...
								  		'duong_kinh_xi_lanh_hanh_trinh_piston',
								  		...
								  		'duong_kinh_piston_hanh_trinh_xi_lanh',
								  		...
								  		'he_thong_phanh_phu_khi_xa',

								  		'he_thong_phanh_phu_jake',

								  		'abs_asr',

								  		'he_thong_treo_truoc_sau',
									   ...
									   // 'sssssssdddsssisiiisssssssssssssssssssssssssssssssissssiiisi');
									   // 'sssssssdddsssisiiisssssssssssssssssssssssssssssssssssssssssissssiiisi');
									   // 'sssssssdddsssisiiisssssssssssssssssssssssssssssssssssssssssssssssssssssssssissssiiisi');
									   // 'sssssssdddsssisiiisssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssissssiiisi');
									   // 'sssssssdddsssisiiissssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssissssiiisi');
									   // 'sssssssdddsssisiiissssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssissssiiisi');
									   'sssssssdddsssisiiissssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssiiiissssiiisi');
