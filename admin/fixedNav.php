    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=hang-xe" title="" class="linkMenu <?php if ($_GET["page"] == 'hang-xe') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Hãng xe</a>
            </li>

            <li><a href="index.php?page=model-xe" title="" class="linkMenu <?php if ($_GET["page"] == 'model-xe') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Model xe</a>
            </li>

            <li><a href="index.php?page=dong-xe" title="" class="linkMenu <?php if ($_GET["page"] == 'dong-xe') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Dòng xe</a>
            </li>

            <li><a href="index.php?page=tra-gop" title="" class="linkMenu <?php if ($_GET["page"] == 'tra-gop') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đăng ký trả góp</a>
            </li>

            <li><a href="index.php?page=lai-thu" title="" class="linkMenu <?php if ($_GET["page"] == 'lai-thu') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đăng ký lái thử</a>
            </li>
