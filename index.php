...
<head>
    ...
    <link rel="stylesheet" href="/css/style-nissan.css">
    ...
    if (isset($_GET['page'])){
        ...
        switch ($urlAnalytic) {
            ...
            case 'so-sanh':
                ...
                include_once dirname(__FILE__).DIR_THEMES."sosanh.php"; break;

            case 'loc-xe':
                include_once dirname(__FILE__) . DIR_THEMES . "loc-xe.php";break;
